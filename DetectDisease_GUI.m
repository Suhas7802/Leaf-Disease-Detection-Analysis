...
% Last Modified by GUIDE v2.5 04-Jul-2023 21:56:34
...
if result == 0
    ...
    helpdlg(' Alternaria Alternata ');
     msgbox('REMEDY : A sulfur-based plant fungicide can also help. Cover both the tops and bottoms of leaves with a thin layer of a sulfur-based powder like Bonide Sulfur Plant Fungicide.');
...
elseif result == 1
    ...
    set(handles.edit3,'string',Affect);
    helpdlg(' Anthracnose ');
    msgbox('REMEDY : You can try spraying your plants with a copper-based fungicide, avoiding toxic build up for earthworms and microbes. For trees, try a dormant spray of bordeaux mix.');
    disp('Anthracnose');
elseif result == 2
    R3 = 'Bacterial Blight';
    ...
    helpdlg(' Bacterial Blight ');
     msgbox('REMEDY : use a combination of copper and mancozeb-containing fungicides for control.  Apply fungicides two to three times at seven to 10 day intervals as leaves emerge, but before symptoms develop.');
...
elseif result == 3
    ...
    msgbox('REMEDY : Spray products containing chlorothalonil, myclobutanil or thiophanate-methyl which are most effective for this leaf disease');
...
elseif result == 4
    ...
    msgbox('Congrats! there is no harm to your leaf');
    disp('Healthy Leaf ');
end
% Update GUI
guidata(hObject,handles);
